 ...
 */
public class FeedbackGradingScaleContact {
    ...
    public static void app_launched(Context mContext) {
        SharedPreferences prefs = mContext.getSharedPreferences("feedback contact", 0);
    ...
    public static void showFeedbackDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        webview.loadUrl("http://goo.gl/forms/PFZUKuf7as");
