package lukelunix.ntnumple.links.itslearning;
...
public class ItslearningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_itslearning);

        webview = (WebView) findViewById(R.id.webviewitslearning);
        WebSettings webSettings = webview.getSettings();
        webSettings.setJavaScriptEnabled(true);
        webview.getSettings().setUseWideViewPort(true);
        webview.getSettings().setLoadWithOverviewMode(true);

        webview.loadUrl("https://innsida.ntnu.no/wiki/-/wiki/Norsk/Itslearning");
